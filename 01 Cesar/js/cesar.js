...
function cifrar(){
    ...
    cesar.a(document.getElementById("cadena").value, parseInt(document.getElementById("desplazamiento").value));
}
...
function descifrar(){
    document.getElementById("resultado").innerHTML =
    cesar.b(document.getElementById("cadena").value, parseInt(document.getElementById("desplazamiento").value));
}